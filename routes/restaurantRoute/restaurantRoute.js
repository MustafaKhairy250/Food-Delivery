...
const {adminRole, restaurantRole} = require("../../middleware/role-based-middleware/checkRole");
...
router.get("/:id" , VerifyJWT, adminRole ,getOneRestaurant) // Get one restaurant admin-role
router.get("/", VerifyJWT, restaurantRole ,getOneRestaurant); // Get My restaurant as restaurant-role
